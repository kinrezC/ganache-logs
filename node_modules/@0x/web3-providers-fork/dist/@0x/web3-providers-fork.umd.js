(function (global, factory) {
    ...
    function (_AbstractSocketProvid) {
      ...
      function WebsocketProvider(connection) {
        var _this;
        var reconnectionTimeout = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 5000;
        ...
        _this.reconnectionTimeout = reconnectionTimeout;
        return _this;
      }
      _createClass(WebsocketProvider, [{
        ...
        value: function reconnect() {
          ...
          setTimeout(function () {
            ...
            _this2.once('connect', function () {
              _this2.emit('reconnected');
            });
